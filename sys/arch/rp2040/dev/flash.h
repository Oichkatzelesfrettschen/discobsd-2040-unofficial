...
/*
 * The kernel occupies the low 128K; it measures 90K, so 38K remain
 * for growth. The filesystem starts above it. Keep in step with
 * conf/RP2040.ld.
 */
#define	FLASH_FS_OFFSET		(128UL * 1024)
