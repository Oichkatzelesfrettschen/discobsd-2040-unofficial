...
No V6/V7 filesystem reader existed on the host or in the tools
catalog (`~/Documents/AI/Notes/1_TOOLS.md`; checked, no PDP-11 disk
tool, no `simh`, no pip-installable V6/V7 fs library). A reader was
written against the documented V7 on-disk layout, then corrected twice
