 ...
 * root filesystem lives on it. The STM32 tree guards its SD card header with
 * SD_ENABLED because that board can boot without one.
 */
...
const struct bdevsw bdevsw[] = {
	{	/* 0 - fl, the onboard QSPI flash */
		flopen,		flclose,	flstrategy,
		flsize,		flioctl,	0
	},
	{	/* 1 - sramc */
		NOBDEV
